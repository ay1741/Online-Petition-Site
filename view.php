...
<div id="header">
<div id="insideheader">
<p style="font-size: 40px;color:#E6E6DC;">Bring Back Unit Lunch</p>
</div>
</div>
...
<p style="font-size: 25px;">View the Petition</p><br>
<p>Right here you can view the petition as well as the number of people who have signed it so far. </p>
<br>
...
$name=$rows['name'];
$class=$rows['class'];
echo $name . ' - ' . '#' . $id . '<br/>' . 'Class of ' . $class . '<br/>' . '<hr width="960px"/>'
;}
?>
